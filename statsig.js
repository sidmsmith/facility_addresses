...
function getAppInfo() {
  ...
  // Extract version from title like "Update Facility Addresses v2.2.0"
  ...
  const appName = appNameMatch ? appNameMatch[1].trim() : (title.split(' v')[0] || 'Update Facility Addresses');
